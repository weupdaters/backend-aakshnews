...
<form id="post-create-form" class="row">
    ...
    <div class="col-xxl-8 col-xl-8 col-lg-8 mb-4">
        ...
        <div class="news-page-card">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" id="post-title" class="form-control form-control-modern w-100" required placeholder="Enter headline in Punjabi, Hindi, or English..." maxlength="200">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="source" id="post-source" class="form-control form-control-modern w-100" placeholder="e.g. PTI, ANI, Bureau, etc.">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="short_description" id="post-short-desc" class="form-control form-control-modern w-100" rows="3" maxlength="300" placeholder="Write a short summary of the article (will be used in listings and social media)..."></textarea>
                <div class="d-flex justify-content-end mt-1">
            ...
            <div class="mb-4">
                ...
                <!-- Textarea Editor -->
                <textarea name="content" id="post-content" class="form-control rounded-bottom rounded-top-0 border-top-0 w-100" rows="10" required placeholder="Write your news content here..." style="border-color: #E2E8F0; font-size: 14px; line-height: 1.6;"></textarea>
                <div class="d-flex justify-content-end mt-1">
        ...
        <div class="news-page-card" id="multilingual-hub-card" style="border: 1.5px solid #BFDBFE; background: #F8FAFC;">
            <div class="card-header-flex flex-wrap gap-2">
                <div class="card-header-left">
                    ...
                    <div>
                        ...
                        <div class="card-subtitle-sub">Type in <strong>any</strong> language (Punjabi, Hindi, or English) — auto-translates instantly with 100% manual edit control!</div>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-2">
            ...
            <div id="lang-pane-en" class="lang-pane bg-white p-3 rounded-3 border" style="border-color: #E2E8F0;">
                ...
                <input type="text" name="title_en" id="post-title-en" class="form-control form-control-modern w-100 mb-3" placeholder="Enter headline in English (or auto-translated)...">
                ...
                <textarea name="content_en" id="post-content-en" class="form-control form-control-modern w-100" rows="5" placeholder="Enter full story in English (or auto-translated)..."></textarea>
            </div>
            ...
            <div id="lang-pane-hi" class="lang-pane d-none bg-white p-3 rounded-3 border" style="border-color: #E2E8F0;">
                ...
                <input type="text" name="title_hi" id="post-title-hi" class="form-control form-control-modern w-100 mb-3" placeholder="हिंदी में शीर्षक दर्ज करें (या ऑटो-ट्रांसलेट होगा)...">
                ...
                <textarea name="content_hi" id="post-content-hi" class="form-control form-control-modern w-100" rows="5" placeholder="हिंदी में समाचार का पूरा विवरण दर्ज करें..."></textarea>
            </div>
            ...
            <div id="lang-pane-pb" class="lang-pane d-none bg-white p-3 rounded-3 border" style="border-color: #E2E8F0;">
                ...
                <input type="text" name="title_pb" id="post-title-pb" class="form-control form-control-modern w-100 mb-3" placeholder="ਪੰਜਾਬੀ ਵਿੱਚ ਸਿਰਲੇਖ ਦਰਜ ਕਰੋ (ਜਾਂ ਆਟੋ-ਟਰਾਂਸਲੇਟ ਹੋਵੇਗਾ)...">
                ...
                <textarea name="content_pb" id="post-content-pb" class="form-control form-control-modern w-100" rows="5" placeholder="ਪੰਜਾਬੀ ਵਿੱਚ ਖ਼ਬਰ ਦਾ ਪੂਰਾ ਵੇਰਵਾ ਦਰਜ ਕਰੋ..."></textarea>
            </div>
            ...
            <div class="mt-3 p-2 rounded-2 d-flex align-items-center gap-2 font-xs" style="background: #EFF6FF; color: #1E40AF; border: 1px solid #DBEAFE;">
                ...
                <span><strong>Guarantee:</strong> Even if you leave any language tab blank, the system automatically detects your input and translates it before publishing so the news appears in English, Hindi, and Punjabi across the website!</span>
            </div>
        </div>
    ...
    <div class="col-xxl-4 col-xl-4 col-lg-4 mb-4">
        ...
        <div class="news-page-card">
            ...
            <div class="mb-2">
                <input type="text" name="image_url" id="post-image-url" class="form-control form-control-modern font-xs" placeholder="Or paste image URL...">
            ...
            <div id="featured-image-preview-container" class="mb-3 p-2 bg-light rounded border position-relative" style="display: none;">
                ...
                <div class="position-relative overflow-hidden rounded border bg-dark" style="max-height: 160px;">
                    <img id="featured-image-preview-img" src="" alt="Featured Preview" class="w-100 object-fit-cover" style="max-height: 160px; display: block;">
                </div>
            </div>
            ...
            <div class="d-flex align-items-center gap-2 overflow-auto py-1" id="preset-thumbnails-row">
                <img src="/top_story_punjab_1784880621670.jpg" alt="Preset 1" class="rounded object-fit-cover shadow-sm thumb-pick border border-primary" style="width: 64px; height: 44px; cursor: pointer;" onclick="selectThumbnail('/top_story_punjab_1784880621670.jpg', this)">
                ...
                <img src="https://images.unsplash.com/photo-1577495508048-b635879837f1?w=600&auto=format&fit=crop&q=80" alt="Preset 3" class="rounded object-fit-cover shadow-sm thumb-pick" style="width: 64px; height: 44px; cursor: pointer;" onclick="selectThumbnail('https://images.unsplash.com/photo-1577495508048-b635879837f1?w=600&auto=format&fit=crop&q=80', this)">
            </div>
        </div>
        ...
        <div class="news-page-card">
            ...
            <div class="serp-card mb-3">
                ...
                <div id="serp-preview-desc" class="text-muted" style="font-size: 11.5px; line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                    Major financial support for widowed and destitute women across Punjab. The scheme aims to empower beneficiaries with instant DBT payouts...
                </div>
            </div>
...
<script>
    ...
    function updateCounters() {
        ...
        $('#serp-preview-title').text(metaTitle || title || 'Punjab Govt Releases Over Rs. 305 Crore in...');
        $('#serp-preview-desc').text(metaDesc || desc || 'Major financial support for widowed and destitute women across Punjab...');
    }
    ...
    $(document).ready(function() {
        ...
        $('#post-create-form').on('submit', function(e) {
            ...
            var payload = {
                ...
                image_url: $('#post-image-url').val() || '/top_story_punjab_1784880621670.jpg',
            ...
            $submitBtn.html('<i data-lucide="loader-2" class="lucide-spin" style="width:17px;height:17px;"></i> Publishing...').prop('disabled', true);
            if (window.lucide) lucide.createIcons();
