    ...
    <div class="col-xxl-8 col-xl-8 col-lg-8 mb-4">
        ...
        <div class="news-page-card">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" id="post-title" class="form-control form-control-modern w-100" required placeholder="Enter a catchy and clear title..." maxlength="200">
        ...
        <div class="news-page-card">
            ...
            <div id="lang-pane-en" class="lang-pane">
                <div class="mb-3">
                    ...
                    <input type="text" name="title_en" id="post-title-en" class="form-control form-control-modern w-100" placeholder="Enter title in English...">
                </div>
                <div>
                    <label class="font-xs text-muted mb-1" style="font-weight: 600;">Translated Content</label>
                    <textarea name="content_en" id="post-content-en" class="form-control form-control-modern w-100" rows="4" placeholder="Enter content in English..."></textarea>
                </div>
            </div>
            ...
            <div id="lang-pane-hi" class="lang-pane d-none">
                <div class="mb-3">
                    ...
                    <input type="text" name="title_hi" id="post-title-hi" class="form-control form-control-modern w-100" placeholder="हिंदी में शीर्षक दर्ज करें...">
                </div>
                <div>
                    <label class="font-xs text-muted mb-1" style="font-weight: 600;">Translated Content (Hindi)</label>
                    <textarea name="content_hi" id="post-content-hi" class="form-control form-control-modern w-100" rows="4" placeholder="हिंदी में विस्तृत सामग्री दर्ज करें..."></textarea>
                </div>
            </div>
            ...
            <div id="lang-pane-pb" class="lang-pane d-none">
                <div class="mb-3">
                    ...
                    <input type="text" name="title_pb" id="post-title-pb" class="form-control form-control-modern w-100" placeholder="ਪੰਜਾਬੀ ਵਿੱਚ ਸਿਰਲੇਖ ਦਰਜ ਕਰੋ...">
                </div>
                <div>
                    <label class="font-xs text-muted mb-1" style="font-weight: 600;">Translated Content (Punjabi)</label>
                    <textarea name="content_pb" id="post-content-pb" class="form-control form-control-modern w-100" rows="4" placeholder="ਪੰਜਾਬੀ ਵਿੱਚ ਖ਼ਬਰ ਦਾ ਵੇਰਵਾ ਦਰਜ ਕਰੋ..."></textarea>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        $('#btn-auto-translate').on('click', function() {
            ...
            $.when.apply($, promises).always(function() {
                $btn.html(originalHtml).prop('disabled', false);
                if (window.lucide) lucide.createIcons();
                alert('Translations completed for English, Hindi, and Punjabi!');
            });
        });
