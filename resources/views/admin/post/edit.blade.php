...
<div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4 page-header-wrap">
    <div>
        <h3 class="page-main-title">Edit News Article</h3>
        <p class="page-main-desc">Update story details, translate multilingual text and manage media assets for Aaksh News 24.</p>
    </div>
    <div class="text-end page-header-actions">
        <div class="d-flex align-items-center gap-1 font-xs text-muted mb-2 justify-content-end" style="font-size: 12px;">
            ...
            <span>&gt;</span>
            <span style="color: #2563EB; font-weight: 600;">Edit Article</span>
        </div>
        ...
        <div class="news-page-card">
            ...
            <div class="collapse pt-3 mt-3 border-top" id="collapseAdvancedOptions">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 mb-2">
                        <label class="form-label-custom">Views Count</label>
            ...
            if (!title) {
                ...
                if (window.Swal) {
                    Swal.fire({
                        ...
                        text: 'Please enter the news headline before saving changes.',
