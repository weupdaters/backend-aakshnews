    ...
    <div class="col-lg-8 mb-4">
        <div class="panel-white">
            <div class="panel-body p-4">
                <form action="/admin/breaking-news/{{ $breakingNews->id }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" class="form-control w-100 @error('title') is-invalid @enderror" placeholder="Enter breaking news text here..." style="height: 46px; border-radius: 8px;" value="{{ old('title', $breakingNews->title) }}" required>
                        @error('title')
                    ...
                    <div class="mb-4">
                        ...
                        <select name="is_active" class="form-control w-100" style="height: 46px; border-radius: 8px;">
                            <option value="1" {{ $breakingNews->is_active ? 'selected' : '' }}>Active</option>
