...
<div class="box-heading mb-4">
    <div class="box-title">
        <h3 class="mb-1">Add Advertisement</h3>
        <p class="text-muted mb-0 font-sm">Configure and upload advertisement banner images for specific locations.</p>
    </div>
    ...
    <div class="col-lg-10 mb-4">
        <div class="panel-white">
            <div class="panel-body p-4">
                <form action="/admin/advertisement" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select name="name" class="form-control w-100 @error('name') is-invalid @enderror" style="height: 46px; border-radius: 8px;" required>
                            ...
                            <option value="Sidebar Banner Ad (300x250)">Sidebar Banner Ad (300x250)</option>
                            <option value="Header Horizontal Banner (728x90)">Header Horizontal Banner (728x90)</option>
                            <option value="Footer Horizontal Banner (728x90)">Footer Horizontal Banner (728x90)</option>
                            <option value="In-Feed Banner Ad (600x150)">In-Feed Banner Ad (600x150)</option>
                        </select>
                        @error('name')
                    ...
                    <!-- Upload Banner Image -->
                    <div class="mb-4">
                        <label class="font-sm color-text-mutted mb-2" style="font-weight: 600;">Upload (Single Image) <span class="text-danger">*</span></label>
                        <div class="custom-file-upload border rounded-3 p-4 text-center bg-light" style="border: 2px dashed #cbd5e1 !important; cursor: pointer; position: relative;">
                            <input type="file" name="image" id="ad-image-input" class="form-control" style="position: absolute; inset: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" accept="image/*" required>
                            
                            <div id="upload-placeholder" class="py-3">
                                <!-- Overlapping image mockup icons matching the user's screenshot -->
                            ...
                            <div id="image-preview-container" class="d-none py-2">
                                <img id="image-preview" src="#" alt="Preview" class="img-fluid rounded shadow-sm" style="max-height: 200px; object-fit: contain;">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="link_url" class="form-control w-100" placeholder="https://example.com or sponsor website" style="height: 46px; border-radius: 8px;">
